...
var G__31491 = o;
reagent.impl.template.goog$module$goog$object.set(G__31491,reagent.impl.template.cached_prop_name(k),(reagent.impl.template.convert_prop_value.cljs$core$IFn$_invoke$arity$1 ? reagent.impl.template.convert_prop_value.cljs$core$IFn$_invoke$arity$1(v) : reagent.impl.template.convert_prop_value.call(null,v)));
...
return (function() { 
var G__31509__delegate = function (args){
...
while (G__31510__i < G__31510__a.length) {G__31510__a[G__31510__i] = arguments[G__31510__i + 0]; ++G__31510__i;}
  args = new cljs.core.IndexedSeq(G__31510__a,0,null);
} 
...
var args = cljs.core.seq(arglist__31511);
...
var G__31492 = o;
reagent.impl.template.goog$module$goog$object.set(G__31492,reagent.impl.template.cached_custom_prop_name(k),reagent.impl.template.convert_prop_value(v));
...
if(cljs.core.ifn_QMARK_(x)){
return (function() { 
var G__31512__delegate = function (args){
return cljs.core.apply.cljs$core$IFn$_invoke$arity$2(x,args);
};
...
while (G__31513__i < G__31513__a.length) {G__31513__a[G__31513__i] = arguments[G__31513__i + 0]; ++G__31513__i;}
  args = new cljs.core.IndexedSeq(G__31513__a,0,null);
} 
...
var args = cljs.core.seq(arglist__31514);
...
var G__31493 = props;
var G__31493__$1 = (((((!((id == null)))) && ((new cljs.core.Keyword(null,"id","id",-1388402092).cljs$core$IFn$_invoke$arity$1(props) == null))))?cljs.core.assoc.cljs$core$IFn$_invoke$arity$3(G__31493,new cljs.core.Keyword(null,"id","id",-1388402092),id):G__31493);
if(cljs.core.truth_(class$)){
return cljs.core.assoc.cljs$core$IFn$_invoke$arity$3(G__31493__$1,new cljs.core.Keyword(null,"class","class",-2030961996),reagent.impl.util.class_names.cljs$core$IFn$_invoke$arity$2(class$,(function (){var or__4253__auto__ = new cljs.core.Keyword(null,"class","class",-2030961996).cljs$core$IFn$_invoke$arity$1(props);
...
var props__$1 = reagent.impl.template.set_id_class((function (){var G__31494 = props;
if(cljs.core.truth_(class$)){
return cljs.core.assoc.cljs$core$IFn$_invoke$arity$3(G__31494,new cljs.core.Keyword(null,"class","class",-2030961996),reagent.impl.util.class_names.cljs$core$IFn$_invoke$arity$1(class$));
} else {
return G__31494;
}
})(),id_class);
...
var G__31495 = (cljs.core.count(argv) - first_child);
switch (G__31495) {
case (0):
...
var vec__31496 = cljs.core.next(cljs.core.re_matches(reagent.impl.template.re_tag,cljs.core.name(hiccup_tag)));
var tag = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__31496,(0),null);
var id = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__31496,(1),null);
var className = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__31496,(2),null);
...
var temp__5757__auto___31516 = reagent.impl.util.react_key_from_vec(v);
if((temp__5757__auto___31516 == null)){
} else {
var key_31517 = temp__5757__auto___31516;
(jsprops.key = key_31517);
}
...
var temp__5757__auto___31518 = reagent.impl.util.react_key_from_vec(v);
if((temp__5757__auto___31518 == null)){
} else {
var key_31519 = temp__5757__auto___31518;
(jsprops.key = key_31519);
}
...
var temp__5757__auto___31522 = reagent.impl.util.react_key_from_vec(argv);
if((temp__5757__auto___31522 == null)){
} else {
var key_31523 = temp__5757__auto___31522;
(jsprops.key = key_31523);
}
...
var temp__5757__auto___31528 = reagent.impl.util.get_react_key(cljs.core.meta(argv));
if((temp__5757__auto___31528 == null)){
} else {
var key_31529 = temp__5757__auto___31528;
(jsprops.key = key_31529);
}
...
var temp__5757__auto___31530 = reagent.impl.util.get_react_key(cljs.core.meta(argv));
if((temp__5757__auto___31530 == null)){
} else {
var key_31531 = temp__5757__auto___31530;
(jsprops.key = key_31531);
}
...
return cljs.core.into_array.cljs$core$IFn$_invoke$arity$1(cljs.core.map.cljs$core$IFn$_invoke$arity$2((function (p1__31499_SHARP_){
return reagent.impl.protocols.as_element(compiler,p1__31499_SHARP_);
}),s));
});
...
var ctx = ({});
var vec__31500 = reagent.ratom.check_derefs((function (){
return reagent.impl.template.expand_seq_dev(x,ctx,compiler);
}));
var res = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__31500,(0),null);
var derefed = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__31500,(1),null);
...
break;
default:
var G__31537 = cljs.core.with_meta(new cljs.core.PersistentVector(null, 2, 5, cljs.core.PersistentVector.EMPTY_NODE, [cljs.core.subs.cljs$core$IFn$_invoke$arity$3(n,(0),pos),cljs.core.assoc.cljs$core$IFn$_invoke$arity$3(cljs.core.with_meta(v,null),(0),cljs.core.subs.cljs$core$IFn$_invoke$arity$2(n,(pos + (1))))], null),cljs.core.meta(v));
var G__31538 = compiler;
v = G__31537;
compiler = G__31538;
continue;
...
if((typeof reagent !== 'undefined') && (typeof reagent.impl !== 'undefined') && (typeof reagent.impl.template !== 'undefined') && (typeof reagent.impl.template.t_reagent$impl$template31506 !== 'undefined')){
} else {
...
*/
reagent.impl.template.t_reagent$impl$template31506 = (function (opts,id,fn_to_element,parse_fn,meta31507){
this.opts = opts;
this.id = id;
...
(reagent.impl.template.t_reagent$impl$template31506.prototype.cljs$core$IWithMeta$_with_meta$arity$2 = (function (_31508,meta31507__$1){
var self__ = this;
var _31508__$1 = this;
return (new reagent.impl.template.t_reagent$impl$template31506(self__.opts,self__.id,self__.fn_to_element,self__.parse_fn,meta31507__$1));
}));

(reagent.impl.template.t_reagent$impl$template31506.prototype.cljs$core$IMeta$_meta$arity$1 = (function (_31508){
var self__ = this;
var _31508__$1 = this;
return self__.meta31507;
}));

(reagent.impl.template.t_reagent$impl$template31506.prototype.reagent$impl$protocols$Compiler$ = cljs.core.PROTOCOL_SENTINEL);

(reagent.impl.template.t_reagent$impl$template31506.prototype.reagent$impl$protocols$Compiler$get_id$arity$1 = (function (this$){
var self__ = this;
var this$__$1 = this;
return self__.id;
}));

(reagent.impl.template.t_reagent$impl$template31506.prototype.reagent$impl$protocols$Compiler$parse_tag$arity$3 = (function (this$,tag_name,tag_value){
var self__ = this;
var this$__$1 = this;
...
(reagent.impl.template.t_reagent$impl$template31506.prototype.reagent$impl$protocols$Compiler$as_element$arity$2 = (function (this$,x){
var self__ = this;
var this$__$1 = this;
return reagent.impl.template.as_element(this$__$1,x,self__.fn_to_element);
}));

(reagent.impl.template.t_reagent$impl$template31506.prototype.reagent$impl$protocols$Compiler$make_element$arity$5 = (function (this$,argv,component,jsprops,first_child){
var self__ = this;
var this$__$1 = this;
return reagent.impl.template.make_element(this$__$1,argv,component,jsprops,first_child);
}));

(reagent.impl.template.t_reagent$impl$template31506.getBasis = (function (){
return new cljs.core.PersistentVector(null, 5, 5, cljs.core.PersistentVector.EMPTY_NODE, [new cljs.core.Symbol(null,"opts","opts",1795607228,null),new cljs.core.Symbol(null,"id","id",252129435,null),new cljs.core.Symbol(null,"fn-to-element","fn-to-element",-1764467095,null),new cljs.core.Symbol(null,"parse-fn","parse-fn",-836029424,null),new cljs.core.Symbol(null,"meta31507","meta31507",-2032425587,null)], null);
}));

(reagent.impl.template.t_reagent$impl$template31506.cljs$lang$type = true);

(reagent.impl.template.t_reagent$impl$template31506.cljs$lang$ctorStr = "reagent.impl.template/t_reagent$impl$template31506");

(reagent.impl.template.t_reagent$impl$template31506.cljs$lang$ctorPrWriter = (function (this__4491__auto__,writer__4492__auto__,opt__4493__auto__){
return cljs.core._write(writer__4492__auto__,"reagent.impl.template/t_reagent$impl$template31506");
}));

/**
 * Positional factory function for reagent.impl.template/t_reagent$impl$template31506.
 */
reagent.impl.template.__GT_t_reagent$impl$template31506 = (function reagent$impl$template$create_compiler_$___GT_t_reagent$impl$template31506(opts__$1,id__$1,fn_to_element__$1,parse_fn__$1,meta31507){
return (new reagent.impl.template.t_reagent$impl$template31506(opts__$1,id__$1,fn_to_element__$1,parse_fn__$1,meta31507));
});

}

return (new reagent.impl.template.t_reagent$impl$template31506(opts,id,fn_to_element,parse_fn,cljs.core.PersistentArrayMap.EMPTY));
});

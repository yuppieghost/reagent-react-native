...
var shadow$remote$runtime$api$IRuntime$relay_msg$dyn_26614 = (function (runtime,msg){
...
return shadow$remote$runtime$api$IRuntime$relay_msg$dyn_26614(runtime,msg);
}
});

var shadow$remote$runtime$api$IRuntime$add_extension$dyn_26615 = (function (runtime,key,spec){
var x__4550__auto__ = (((runtime == null))?null:runtime);
...
return shadow$remote$runtime$api$IRuntime$add_extension$dyn_26615(runtime,key,spec);
}
});

var shadow$remote$runtime$api$IRuntime$del_extension$dyn_26620 = (function (runtime,key){
var x__4550__auto__ = (((runtime == null))?null:runtime);
...
return shadow$remote$runtime$api$IRuntime$del_extension$dyn_26620(runtime,key);
}
});
...
var shadow$remote$runtime$api$Inspectable$describe$dyn_26637 = (function (thing,opts){
...
return shadow$remote$runtime$api$Inspectable$describe$dyn_26637(thing,opts);
}
}
});
...
var shadow$remote$runtime$api$IEvalCLJS$_cljs_eval$dyn_26644 = (function (runtime,input,callback){
var x__4550__auto__ = (((runtime == null))?null:runtime);
...
return shadow$remote$runtime$api$IEvalCLJS$_cljs_eval$dyn_26644(runtime,input,callback);
}
});
...
var shadow$remote$runtime$api$IEvalJS$_js_eval$dyn_26651 = (function (runtime,code){
var x__4550__auto__ = (((runtime == null))?null:runtime);
...
return shadow$remote$runtime$api$IEvalJS$_js_eval$dyn_26651(runtime,code);
}
});


shadow.remote.runtime.api.cljs_eval = (function shadow$remote$runtime$api$cljs_eval(runtime,p__26606,callback){
var map__26607 = p__26606;
var map__26607__$1 = cljs.core.__destructure_map(map__26607);
var input = map__26607__$1;
var code = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__26607__$1,new cljs.core.Keyword(null,"code","code",1586293142));
var ns = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__26607__$1,new cljs.core.Keyword(null,"ns","ns",441598760));
